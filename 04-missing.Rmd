...
library(plotrix)
piechart<-pie3D(wb1[1:5,]$n,labels=wb1[1:5,]$ï..Country,explode=0.1,main="Pie Chart of Some Countries with missing values ",col=c("brown","#ddaa00","pink","#dd00dd"),labelcex=1.1)
```
