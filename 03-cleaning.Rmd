...
kable(Fao[Fao$Area=="Russian Federation",][3:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="Canada",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="China",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="United States of America",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="Brazil",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="Australia",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="India",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="Argentina",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="Kazakhstan",][1:6,c("Area","Year","Value")])
...
```{r,null_prefix=TRUE,fig.height=4,fig.width=6}
kable(Fao[Fao$Area=="Algeria",][1:6,c("Area","Year","Value")])
